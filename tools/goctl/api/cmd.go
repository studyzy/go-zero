...
import (
	...
	"github.com/studyzy/go-zero/tools/goctl/api/apigen"
	"github.com/studyzy/go-zero/tools/goctl/api/dartgen"
	"github.com/studyzy/go-zero/tools/goctl/api/docgen"
	"github.com/studyzy/go-zero/tools/goctl/api/format"
	"github.com/studyzy/go-zero/tools/goctl/api/gogen"
	"github.com/studyzy/go-zero/tools/goctl/api/javagen"
	"github.com/studyzy/go-zero/tools/goctl/api/ktgen"
	"github.com/studyzy/go-zero/tools/goctl/api/new"
	"github.com/studyzy/go-zero/tools/goctl/api/swagger"
	"github.com/studyzy/go-zero/tools/goctl/api/tsgen"
	"github.com/studyzy/go-zero/tools/goctl/api/validate"
	"github.com/studyzy/go-zero/tools/goctl/config"
	"github.com/studyzy/go-zero/tools/goctl/internal/cobrax"
	"github.com/studyzy/go-zero/tools/goctl/plugin"
)
