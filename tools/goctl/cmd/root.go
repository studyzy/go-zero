...
import (
	...
	"github.com/studyzy/go-zero/tools/goctl/api"
	"github.com/studyzy/go-zero/tools/goctl/bug"
	"github.com/studyzy/go-zero/tools/goctl/config"
	"github.com/studyzy/go-zero/tools/goctl/docker"
	"github.com/studyzy/go-zero/tools/goctl/env"
	"github.com/studyzy/go-zero/tools/goctl/gateway"
	"github.com/studyzy/go-zero/tools/goctl/internal/cobrax"
	"github.com/studyzy/go-zero/tools/goctl/internal/version"
	"github.com/studyzy/go-zero/tools/goctl/kube"
	"github.com/studyzy/go-zero/tools/goctl/migrate"
	"github.com/studyzy/go-zero/tools/goctl/model"
	"github.com/studyzy/go-zero/tools/goctl/quickstart"
	"github.com/studyzy/go-zero/tools/goctl/rpc"
	"github.com/studyzy/go-zero/tools/goctl/tpl"
	"github.com/studyzy/go-zero/tools/goctl/upgrade"
